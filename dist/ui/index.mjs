...
var FilterDrawer = ({
  ...
  const renderField = (field, index) => {
    ...
    if (isInputSelect(field)) {
      return /* @__PURE__ */ jsx(Grid, { size: (_a = field.xs) != null ? _a : 1, children: /* @__PURE__ */ jsx(input_select_default, __spreadProps(__spreadValues({}, field), { id: `inputSM${index}`, fullWidth: true })) }, `inputSelect-${index}`);
    }
    return /* @__PURE__ */ jsx(Grid, { size: (_b = field.xs) != null ? _b : 1, children: /* @__PURE__ */ jsx(input_default, __spreadProps(__spreadValues({}, field), { fullWidth: true })) }, `input-${index}`);
  };
