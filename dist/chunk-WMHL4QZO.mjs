...
function getDrawerFloatingStyle(swipeDirection) {
...
function drawerRoundedClassName(rounded = "3xl") {
  if (typeof rounded === "number") return `[--drawer-radius:${rounded}px]`;
  if (rounded in DRAWER_ROUNDED_TOKENS) {
    return `[--drawer-radius:${DRAWER_ROUNDED_TOKENS[rounded]}]`;
  }
...
function DrawerContent(_a) {
  ...
  const floatingStyle = floating ? getDrawerFloatingStyle(swipeDirection) : void 0;
...
//# sourceMappingURL=chunk-WMHL4QZO.mjs.map
//# sourceMappingURL=chunk-WMHL4QZO.mjs.map