import { cn, nvl, removeDigits, formatItem150, formatItem170, removeNonDigits, removeTextOnly, formatPriceBrl, formatPhoneBr, formatCpfCnpj } from './chunk-N2ZRDZYM.mjs';
import { __spreadProps, __spreadValues, __objRest } from './chunk-YOSPWY5K.mjs';
import { createTheme, styled, Tabs as Tabs$1, Tab as Tab$1, TextField, Box, ThemeProvider, useMediaQuery, Drawer as Drawer$1, Grid, InputAdornment, IconButton } from '@mui/material';
import { Tooltip, Button, Input as Input$1, ActionIcon } from '@mantine/core';
...
import { memo, useState, useMemo, useId, useCallback } from 'react';
...
var DRAWER_DEFAULT_SNAP_POINTS = [0.3, 0.9];
...
var DRAWER_OVERLAY_SNAP_OPACITY_CLASSNAME = "opacity-[max(var(--drawer-overlay-min-opacity,0.5),calc(1-var(--drawer-swipe-progress)))] [--drawer-overlay-min-opacity:0.5]";
var DRAWER_OVERLAY_MODAL_OPACITY_CLASSNAME = "opacity-100";
...
// src/components/ui/drawer/utils/functions.ts
function resolveDrawerSnapPoints(points, snapPoints) {
...
function Drawer2(_a) {
  ...
  const hasSnapPoints = resolvedSnapPoints != null && resolvedSnapPoints.length > 0;
  const effectiveShowSwipeHandle = showSwipeHandle != null ? showSwipeHandle : hasSnapPoints;
...
function DrawerOverlay(_a) {
  ...
  const overlayModal = (_b2 = overlayModalProp != null ? overlayModalProp : context == null ? void 0 : context.overlayModal) != null ? _b2 : !(context == null ? void 0 : context.hasSnapPoints);
  ...
  return /* @__PURE__ */ jsx(
    ...
    __spreadProps(__spreadValues({
      ...
      "data-overlay-modal": overlayModal ? "" : void 0,
      className: cn(
        DRAWER_OVERLAY_CLASSNAME,
        overlayModal ? DRAWER_OVERLAY_MODAL_OPACITY_CLASSNAME : DRAWER_OVERLAY_SNAP_OPACITY_CLASSNAME,
        className
      )
    }, props), {
...
//# sourceMappingURL=chunk-4YG2OP6T.mjs.map
//# sourceMappingURL=chunk-4YG2OP6T.mjs.map